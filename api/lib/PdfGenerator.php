...
class PdfGenerator {
    ...
    private function replacePlaceholders(string $html, string $clientName, string $date, array $extra = []): string {
        ...
        $replacements = [
            ...
            '{{booking_number}}'    => htmlspecialchars($extra['bookingNumber'] ?? ''),
            ...
            '{{payment_note}}'      => htmlspecialchars($extra['paymentNote'] ?? 'Bitte überweisen Sie den Betrag vor dem Termin.'),
    ...
    public function replacePlaceholdersSample(string $html): string {
        ...
        return $this->replacePlaceholders($html, 'Max Mustermann', $today, [
            ...
            'paymentNote'    => 'Bitte überweisen Sie den Betrag vor dem Termin.',
        ]);
    }
